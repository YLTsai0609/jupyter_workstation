...
#  
#  Prior to JupyterHub 2.0, this returns a 503 when any request comes in for a
#  user server that is currently not running. By default, JupyterHub 2.0 will
...
#  future release.
#  Default: True
# c.JupyterHub.use_legacy_stopped_server_status_code = True
